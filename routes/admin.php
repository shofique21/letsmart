...
Route::middleware(['isAdmin'])->group(function () {
    ...
    Route::get('orders-list', [OrderListController::class,'orderList'])->name('order.list');
    Route::get('order-view/{id}', [OrderListController::class, 'orderDetails'])->name('order.view');
});